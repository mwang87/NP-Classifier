...
log_dir="logs\(011020)HWK_sAug_0102_1ch_QC"
tensorboard_callback = tf.keras.callbacks.TensorBoard(log_dir=log_dir, histogram_freq=1)
checkpoint = keras.callbacks.ModelCheckpoint(filepath='checkpoints/(011020)HWK_sAug_0102_1ch_QC.hdf5',monitor='val_loss',mode='min',save_best_only=True)
...
model = keras.models.load_model('checkpoints/(011020)HWK_sAug_0102_1ch_0.2.hdf5')
