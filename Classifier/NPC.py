...
#Super_class
super_model = keras.models.load_model('Final_model/FP to Classifier/(0513)DNP_based_super_classifier_final.hdf5')
#Class
Lignans_model = keras.models.load_model('Final_model/FP to Classifier/0513_DNP_based_sub_classifier_Lignans.hdf5')
Benzofuranoids_model = keras.models.load_model('Final_model/FP to Classifier/0513_DNP_based_sub_classifier_Benzofuranoids.hdf5')
Steroids_and_Sterols_model = keras.models.load_model('Final_model/FP to Classifier/0513_DNP_based_sub_classifier_Steroids and Sterols.hdf5')
Aminoacids_and_peptides_model = keras.models.load_model('Final_model/FP to Classifier/0513_DNP_based_sub_classifier_Aminoacids and peptides.hdf5')
Flavonoids_model = keras.models.load_model('Final_model/FP to Classifier/0513_DNP_based_sub_classifier_Flavonoids.hdf5')
Aliphatic_natural_products_model = keras.models.load_model('Final_model/FP to Classifier/0513_DNP_based_sub_classifier_Aliphatic natural products.hdf5')
Oxygenheterocycles_model = keras.models.load_model('Final_model/FP to Classifier/0513_DNP_based_sub_classifier_Oxygenheterocycles.hdf5')
Benzopyranoids_model = keras.models.load_model('Final_model/FP to Classifier/0513_DNP_based_sub_classifier_Benzopyranoids.hdf5')
Alkaloids_model = keras.models.load_model('Final_model/FP to Classifier/0513_DNP_based_sub_classifier_Alkaloids.hdf5')
Tannins_model = keras.models.load_model('Final_model/FP to Classifier/0513_DNP_based_sub_classifier_Tannins.hdf5')
Simple_aromatic_natural_products_model = keras.models.load_model('Final_model/FP to Classifier/0513_DNP_based_sub_classifier_Simple aromatic natural products.hdf5')
Polyketides_model = keras.models.load_model('Final_model/FP to Classifier/0513_DNP_based_sub_classifier_Polyketides.hdf5')
Polypyrroles_model = keras.models.load_model('Final_model/FP to Classifier/0513_DNP_based_sub_classifier_Polypyrroles.hdf5')
Carbohydrates_model = keras.models.load_model('Final_model/FP to Classifier/0513_DNP_based_sub_classifier_Carbohydrates.hdf5')
Terpenoids_model = keras.models.load_model('Final_model/FP to Classifier/0513_DNP_based_sub_classifier_Terpenoids.hdf5')
Polycyclic_aromatic_natural_products_model = keras.models.load_model('Final_model/FP to Classifier/0513_DNP_based_sub_classifier_Polycyclic aromatic natural products.hdf5')
#Terepenoid_subclass
Triterpenoids_model = keras.models.load_model('Final_model/FP to Classifier/0513_DNP_based_sub_classifier_Terpenoids_Triterpenoids.hdf5')
Sesquiterpenoids_model= keras.models.load_model('Final_model/FP to Classifier/0513_DNP_based_sub_classifier_Terpenoids_Sesquiterpenoids.hdf5')
Diterpenoids_model= keras.models.load_model('Final_model/FP to Classifier/0513_DNP_based_sub_classifier_Terpenoids_Diterpenoids.hdf5')
Monoterpenoids_model= keras.models.load_model('Final_model/FP to Classifier/0513_DNP_based_sub_classifier_Terpenoids_Monoterpenoids.hdf5')
Sesterterpenoids_model= keras.models.load_model('Final_model/FP to Classifier/0513_DNP_based_sub_classifier_Terpenoids_Sesterterpenoids.hdf5')
Meroterpenoids_model = keras.models.load_model('Final_model/FP to Classifier/0513_DNP_based_sub_classifier_Terpenoids_Meroterpenoids.hdf5')
    ...
    try:
        ...
        for sup in super_list:
            if sup == 'Lignans':
                ...
                subs = np.where(Aliphatic_natural_products_model.predict(fp.reshape(1,6144))[0]>=0.5)[0]
                for m in subs:
                ...
                for n in sub_list:
                 ...
                 #       if terpene_sub_list == []:
                  #          terpene_sub_list = classes_terpene['Triterpenoids'][np.argmax(Triterpenoids_model.predict(fp.reshape(1,6144)))]+'*'
                        ...
                        subs_terpene = np.where(Sesterterpenoids_model.predict(fp.reshape(1,6144))[0]>=0.5)[0]
                        for o in subs_terpene:
                        ...
                        subs_terpene = np.where(Monoterpenoids_model.predict(fp.reshape(1,6144))[0]>=0.5)[0]
                        for o in subs_terpene:
